...
//    int i;
//    for (i = 1; i <= 100; i++) { //previous: for (i = 1; i < 100; i++)
//      if (i % 15 == 0) {
...
//      mid = (low + high) / 2;
//      if (array[mid] > value) {
//        return binarySearch(array, value, low, mid - 1); //previous: return binarySearch(array, value, low, mid);
